  ...
  return (
    <>
      <button
        ...
        className="px-4 py-3 bg-transparent rounded uppercase text-white border-2 border-dashed border-brand-blue font-semibold text-xl tracking-wide mb-2 relative"
      >
        Select Video
      </button>
      <input
